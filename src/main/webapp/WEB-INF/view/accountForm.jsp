...
<!-- *************************************************** 여기까지 ****************************************************************** -->
	...
	<form:form commandName="account" method="post">
		...
		<form:input path="id" class="form-control" style="width:250px"/>
		<form:errors path="id" />
		<br/>
		
		<form:label path="pwd">비밀번호</form:label>
		<form:password path="pwd" class="form-control" style="width:250px"/>
		<form:errors path="pwd" />
		<br/>
		
		<form:label path="name">이름</form:label>
		<form:input path="name" class="form-control" style="width:250px"/>
		<form:errors path="name" class="error-color" style="font-size:10px; color:red" />
		<br/>
		
		<form:label path="gender">성별</form:label> &nbsp;&nbsp;&nbsp;&nbsp;
		남자 <form:radiobutton path="gender" value="m" />&nbsp;&nbsp;&nbsp;&nbsp;
		여자 <form:radiobutton path="gender" value="w" />
		<form:errors path="gender" class="error-color" style="font-size:10px; color:red" />
		<br/><br/>
		
		<form:label path="phone">전화변호</form:label>
		<form:input path="phone" class="form-control" style="width:250px"/>
		<form:errors path="phone" class="error-color" style="font-size:10px; color:red" />
		<br/>
		
		<form:label path="birthday">생일</form:label>
		<form:input type="date" path="birthday" class="form-control" style="width:250px"/>
		<form:errors path="birthday" class="error-color" style="font-size:10px; color:red" />
		<br/>
		
		<input type="submit" value="가입하기" class="btn bbtn"  style="width: 250px" />
	</form:form>
