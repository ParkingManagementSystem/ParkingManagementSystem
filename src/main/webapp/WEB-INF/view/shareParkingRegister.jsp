...
function getLocation() {
   // 주소로 좌표를 검색합니다
      ...
      geocoder.addr2coord(location, function(status, result) { //여기부터
       ...
       geocoder.addr2coord(document.getElementById("gu").value, function(status, result) { //여기부터
...
<!-- *************************************************** 여기까지 ****************************************************************** -->
   ...
   <form:form commandName="command" action="created" class="form-horizontal" name="form" enctype="multipart/form-data" method="post">
