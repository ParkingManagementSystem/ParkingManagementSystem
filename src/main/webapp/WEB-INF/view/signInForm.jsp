...
<!-- *************************************************** 여기까지 ****************************************************************** -->
	...
	<form:form commandName="account" method="post" action="signIn.do" class="form-group">
		
		<form:errors element="div" class="error-color" style="font-size:10px; color:red"/>
		
		<form:label path="id"> ID </form:label> 
		<form:input path="id" class="form-control" style="width:250px; margin: 0 auto;"/>
		<form:errors path="id" class="error-color" style="font-size:10px; color:red"/><br>
		
		<form:label path="id"> PASSWORD </form:label>
		<form:password path="pwd" class="form-control" style="width:250px; margin: 0 auto;"/>
		<form:errors path="pwd" class="error-color" style="font-size:10px; color:red"/><br>
		
		<input type="submit" value="Sign In" class="btn sbtn" style="width:250px">
		<br/><br/>
		<a href="<c:url value='/account/createAccount.do' />" class="btn bbtn"  style="width: 250px"> Sign Up</a>
