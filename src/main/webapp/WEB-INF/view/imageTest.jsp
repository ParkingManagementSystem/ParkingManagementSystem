...
<!--     <br> -->
<%--     <a href="<c:url value='/imageTest/fileDown.do?fileName=binary.jpg' />">down</a> --%>
    
<%--     <img src="${pageContext.request.contextPath}/imageTest/fileDown.do?fileName=binary.jpg" width="300" height="210"> --%>

<%-- </form> --%>

<form action="${pageContext.request.contextPath}/imageTest/saveImage" enctype="multipart/form-data" method="post">
    <input type="file" name="imgFile" />
