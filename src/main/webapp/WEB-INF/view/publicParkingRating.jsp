...
<center>
	...
	<form action="publicParkingListRating.do?code=${rating.code}" method="post">
 	...
 	<table class="type09">
		<thead>
		    ...
		    <tr>
				<th scope="row">시작일</th>
				<td>${rating.startday} &nbsp;
					${rating.starttimeHour}시 ${rating.starttimeMin}분
				</td>
			</tr>
			<tr>
				<th scope="row">종료일</th>
				<td>${rating.endday} &nbsp;
					${rating.endtimeHour}시 ${rating.endtimeMin}분
				</td>
			</tr>
			<tr>
		...
		<br/>
		<input type="hidden" name="title" value="${rating.title}"/>
		<input type="hidden" name="cost" value="${rating.payment}"/>
		<input type="hidden" name="star" value="${rating.star}"/>
 		<input type="submit" name="submit" value="사용내역 등록"/>
